...
from vestibule.identity.derive import IdentityInvalid, derive_doc_id
...
class ArrivalEnvelope(BaseModel):
    ...
    def _verify_doc_id(self) -> "ArrivalEnvelope":
        ...
        compute_doc_id ultimately delegates to derive_doc_id (vestibule.identity.derive,
...
def compute_doc_id(source: str, blob_path: str) -> str:
    ...
    Delegates to the canonical implementation in vestibule.identity.derive (REQ-002)."""
