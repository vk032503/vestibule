...
from vestibule.identity.derive import IdentityInvalid
...
def test_classify_unknown_code_logs_warning_naming_code(
    ...
    registry = ErrorRegistry()
    code = _new_code("warn")
    with caplog.at_level(logging.WARNING, logger="vestibule.errors.registry"):
...
def test_ragged_error_severity_property_delegates_to_default_registry() -> None:
    ...
    # vestibule.identity.derive) rather than registering a fresh code into _DEFAULT_REGISTRY,
...
def test_config_known_codes_matches_all_codes_after_importing_all_modules() -> None:
    ...
    import vestibule.analyzer.model  # noqa: F401
    import vestibule.chunker.model  # noqa: F401
    import vestibule.embedder.model  # noqa: F401
    import vestibule.envelope.model  # noqa: F401
    ...
    import vestibule.reprocessor.model  # noqa: F401
