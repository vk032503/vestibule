...
from vestibule.analyzer.model import Element
from vestibule.chunker.model import STRATEGY_RECURSIVE, ChunkDraft
from vestibule.chunker.strategies.base import (
    ChunkStrategy,
    join_element_text,
    page_metadata,
