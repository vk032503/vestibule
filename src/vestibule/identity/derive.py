...
`vestibule.envelope.model.compute_doc_id` (REQ-001) delegates to `derive_doc_id` here so
...
def derive_doc_id(source: str, blob_path: str) -> str:
    ...
    Canonical implementation of the doc_id derivation rule; vestibule.envelope.model's
