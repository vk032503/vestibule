...
from ingestion.chunker.conftest import table
from ingestion.chunker.model import OVERSIZED_TABLE_LOG_EVENT, STRATEGY_TABLE_ATOMIC
...
def test_table_atomic_table_larger_than_max_chunk_tokens_emits_one_chunk_plus_warning_log(
    ...
    with caplog.at_level(
        logging.WARNING, logger="ingestion.chunker.strategies.table_atomic"
    ):
        drafts = strategy.chunk_region(
